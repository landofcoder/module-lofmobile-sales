...
use Lofmobile\Sales\Api\InvoiceRepositoryInterface as LofmobileInvoiceRepositoryInterface;

class InvoiceRepository implements LofmobileInvoiceRepositoryInterface
{
    /**
