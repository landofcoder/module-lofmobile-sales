...
use Lofmobile\Sales\Api\OrderRepositoryInterface as LofmobileOrderRepositoryInterface;

class OrderRepository implements LofmobileOrderRepositoryInterface
{
    /**
