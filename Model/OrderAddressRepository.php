...
namespace Lofmobile\Sales\Model;
...
use Lofmobile\Sales\Api\OrderAddressRepositoryInterface as LofmobileOrderAddressRepositoryInterface;

class OrderAddressRepository implements LofmobileOrderAddressRepositoryInterface
{
    /**
